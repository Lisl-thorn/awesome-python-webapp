...
_RZ_TZ = re.compile('^([\+\-])([0-9]{1,2})\:([0-9]{1,2})$')
...
class Request(object):
	...
	def headers(self,header,default=None):
...
class Jinja2TemplateEngine(TemplateEngine):
	"""docstring for Jinja2TemplateEngine"""
...
def _default_error_handler(e,start_response,is_debug):
	...
	if is_debug:
		return _debug()
	return ('<html><body><h1>500 Internal Server Error</h1></body></html>' %str(e))
